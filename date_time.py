...
As you can see, in the datetime module there are many functions, 
...
from datetime import datetime
now = datetime.now()            #datetime is a class and now() is a function/method
print(now) 

                     # 2021-07-08 07:34:46.549883
day = now.day                   # 8
month = now.month               # 7
year = now.year                 # 2021
hour = now.hour                 # 7
...
# there are other like %b or %B to format, just look them up
