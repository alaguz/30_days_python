...
#example code you would put inside the mymodule.py
...
# then Create main.py file in your project directory and import the mymodule.py file.
...
# import the module     # these are in python, not the termianl    # type python in terminal to enter python code
import os
...
if len(sys.argv) < 3:
    print("Usage: python main.py <name> <challenge>")
else:
    name = sys.argv[1]
    challenge = sys.argv[2]
    print(f"Welcome {name}. Enjoy {challenge} challenge!")

exit()

python main.py Asabeneh 30DaysOfPython

python main.py Asabeneh 30DaysOfPython  # run this in the terminal



# to exit sys # in the terminal
sys.exit()
