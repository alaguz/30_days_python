...
lst = [i for i in language]        #“For each character i in language, put i into a list”
print(type(lst)) # list
print(lst)       # ['P', 'y', 't', 'h', 'o', 'n']
...
# Go through each row in list_of_lists, then go through each number in that row, 
# and collect all those numbers into one list.”


list_of_lists = [[1, 2, 3], [4, 5, 6], [7, 8, 9]]    # Nested list
...
See the syntax and the example below. Lambda function does not use return but it explicitly returns the expression.
...
add = lambda x, y: x + y       #Same as the above
...
It keeps code simpler, not more confusing
